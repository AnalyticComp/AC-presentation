...
\documentclass[aspectratio=169]{ACpresentation}
...
%\renewcommand*\ACfootlineLeft{left footline content}
%\renewcommand*\ACfootlineCenter{center footline content}
...
\newcommand*\ACheadline{} % Disable navigation bar for outline.
\begin{frame}{Outline}
  \tableofcontents
\end{frame}
\let\ACheadline\relax % Re-enable navigation bar for outline.
...
\begin{frame}[ACfancy]{Thank you for your Attention!}
  \begin{center}
    \insertauthor
  \end{center}
\end{frame}
